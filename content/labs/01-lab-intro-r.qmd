...
-   **If you do not yet have a GitHub account, create one at [https://github.com/](https://github.com/)**. Tips for selecting a username [^1]:
...
-   In your browser, navigate to [https://github.com/settings/keys](https://github.com/settings/keys)
-   Click "New SSH Key"
-   Set title to DSMLP
