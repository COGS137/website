...
Slides: <iframe class="slide-deck" src="content/lectures/00-welcome-slides.html"></iframe>
...
<i class="fa fa-envelope"></i>   [sellis\@ucsd.edu](mailto:sellis@ucsd.edu) <br> <i class="fa fa-home"></i>   [shanellis.com](http://www.shanellis.com/) <br> <i class="fa fa-university"></i>   Peterson Hall 104 <br> <i class="fa fa-calendar"></i>   Tu/Th 2-3:30PM (Lab: Fri 1-1:50PM)
...
1. Attendance will be incentivized using a daily participation survey.
...
- As of Jan 2023, there are ~18,979 R packages available on **CRAN** (the Comprehensive R Archive Network)^[[CRAN contributed packages](https://cran.r-project.org/web/packages/)]
...
## RStudio Projects^[[RStudio Projects Documentation]( https://support.rstudio.com/hc/en-us/articles/200526207-Using-Projects)] 
...
<span style="background-color: #ADD8E6"><i class="fa fa-user" aria-hidden="true"></i> &nbsp; What is the Bechdel test?</span> 
...
(*optional*) [Student Survey](https://docs.google.com/forms/d/e/1FAIpQLSeVpq52ojcNijOPGlukJ1vDhgtL9TE1axNcvtECkaOCn1g-kA/viewform?usp=sf_link) 
...
::: aside 
\*links to both surveys are also on Canvas
:::
