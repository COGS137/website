...
<i class="fa fa-envelope"></i>   [sellis\@ucsd.edu](mailto:sellis@ucsd.edu) <br> <i class="fa fa-home"></i>   [shanellis.com](http://www.shanellis.com/) <br> <i class="fa fa-university"></i>  MOS 0204 <br> <i class="fa fa-calendar"></i>   Tu/Th 2-3:20PM (Lab: Fri 3-3:50PM)
...
Imagine: You've been asked to carry out a number of wrangling operations on a dataset...
...
Note: StackOverflow is still a helpful resource but ChatGPT/LLMs may be your go to and that's OK. Regardless, let's take a look
