...
knitr::opts_chunk$set(fig.height = 4, dpi = 300, echo=TRUE) 
```
...
- Read in the data ([Data slide](https://cogs137.github.io/website/content/lectures/05-viz-slides.html#/data))
