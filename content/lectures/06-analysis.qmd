...
- Often, this is visual. (That's what we're focusing on first today.)
...
![](images/06/sandra-van-ginhoven.png) ![](images/06/hilary-coe-cronheim.png)
...
![](images/06/auction-video.png)

::: aside
Source: http://www.sothebys.com/en/news-video/videos/2014/07/Old-master-british-paintings-evening-sale-soars-over-estimate.html
:::


## Auctions back in the day

![](images/06/old-auction.png)
...
[`r emo::ji("question")` Which of the previous two bar plots is a more useful representation for visualizing the relationship between gender and hair color?]{style="background-color: #ADD8E6"}
...
[`r emo::ji("question")` How, if at all, the relationship between width and height of paintings vary by whether or not they have any landscape elements?]{style="background-color: #ADD8E6"}
...
-   R4DS Chapter 23: [Model Basics](https://r4ds.had.co.nz/model-intro.html)
