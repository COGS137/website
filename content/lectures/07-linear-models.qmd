...
[`r emo::ji("question")` On average, how tall are paintings that are 60 inches wide?
$$\widehat{Height_{in}} = 3.62 + 0.78~Width_{in}$$]{style="background-color: #ADD8E6"}
...
[`r emo::ji("question")` On average, how tall are paintings that are 400 inches wide?
$$\widehat{Height_{in}} = 3.62 + 0.78~Width_{in}$$]{style="background-color: #ADD8E6"}
...
clearly folks the climate debate rages on."[^1]  <br>
...
## Recap {background-color="#92A86A" .smaller}
