...
# Midterm {background-color="#92A86A"}
...
![](images/09/goodplot.png)

### Plot

```{r ref.label="Eric", echo = FALSE, out.width="100%"}
```

### Code

```{r Eric, fig.show = "hide"}
# Eric890916
...
![](images/09/chalabi-flowers-feature-commonname-1.webp)

### Plot

```{r ref.label="Christine", echo = FALSE, out.width="100%"}
```

### Code

```{r Christine, fig.show = "hide"}
...
![](images/09/biden_pre.png)

### Plot

```{r ref.label="cheng", echo = FALSE, out.width="100%"}
```

### Code

```{r, cheng, fig.show = "hide"}
# get data
...
![](images/09/medals.png)

### Plot

```{r ref.label="Christine2", echo = FALSE, out.width="100%"}
```

### Code

```{r Christine2, fig.show = "hide"}
medals <- tibble(
  country = c(
