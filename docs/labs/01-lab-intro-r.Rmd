...
- If you do not yet have a GitHub account, create one at https://github.com/. Tips for selecting a username ^[1 Source: [Happy git with R](http://happygitwithr.com/github-acct.html#username-advice) by Jenny Bryan.]:
...
knitr::include_graphics("img/01-hello-r/repo_url.png")
```
...
- Hit **Create Project**. You'll be asked for your GitHub username and password here. After you enter these, you're good to go! Open up `hw-01.Rmd` and continue through this lab. Your work/answers for this lab will be submitted in that document.
