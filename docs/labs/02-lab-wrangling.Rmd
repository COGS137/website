...
4. Filter these data to only include storms that occurred during *your* lifetime (your code and results may differ from your classmates!). Within this subset, which storm lasted the longest? Include your code and explain your answer.

5. Among storms that have occurred during your lifetime, what's the mean and median air pressure across all measurements taken? 

6. (optional)

7. (optional) 

*Yay, you're done! Commit all remaining changes, use the commit message "Done with Lab 2! `r emo::ji("muscle")`", and push. Before you wrap up the assignment, make sure all documents are updated on your GitHub repo.*
