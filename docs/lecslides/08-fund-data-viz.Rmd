...
![luke-skywalker](img/08/luke-skywalker.png)
...
![starwars-help](img/08/starwars-help.png)
...
jabba <- image_read("img/08/jabba.png")
...
image_write(out, "img/08/jabbaplot.png", format = "png")
knitr::include_graphics("img/08/jabbaplot.png")
```
