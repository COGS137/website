...
Case Study Data will come from `opencasestudies/OCSdata`, but additional packages will be needed for working with these data: 
...
.question[`r emo::ji("backhand index pointing right")` **Your Turn**: Install these packages in RStudio]
...
mutate(Race_Ethnicity = 
         dplyr::recode(Group, "United States" = "All_races",
                              "Female" = "All_races",
                              "Male" = "All_races"),
...
.question[`r emo::ji("idea")` How would you fix that typo? (Idea is fine; code not neessary)]
